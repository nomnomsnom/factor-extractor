...
window.AgentGraphSimulator = (() => {
  ...
  function deliverableText(config, rounds) {
    ...
    return [
      ...
      "",
      `**${SIM_NOTE}** This page is the configuration studio: it shows how the`,
      "graph would fan out for the settings on the left, but the model calls that",
      "would fill this section need an API key, so they run on your machine rather",
      "than in a public web page.",
      "",
      "## What just happened",
      "",
      ...
      "## Running it for real",
      "",
      "Export the config with the button in the header, then:",
      "",
      "```",
